...
final class VendorTapQualificationTests: XCTestCase {
    ...
    func testReleaseWorkflowLocksTheTwoImmutableQualificationBuilds() throws {
        ...
        XCTAssertTrue(workflow.contains("default: 0.0.2-dev.5"))
        XCTAssertTrue(workflow.contains("default: v0.0.2-dev.5"))
        XCTAssertTrue(workflow.contains(#"^0\.0\.2-dev\.[56]$"#))
        ...
        XCTAssertTrue(workflow.contains("refs/tags/v0.0.2-dev.5^{}"))
