...
public enum HostwrightCapabilityCatalog {
    ...
    private static let catalog: [HostwrightCapability] = [
        ...
        capability("architecture.contracts", "Versioned v0.0.2 public contracts", .experimental, 1, 110, "Manifest v2, Control API v2, Runtime Provider API v2, Storage Provider API v1, Network Provider SPI v1, plugin ABI v1, and state schema v22 are under active qualification.", [.unitContract, .migrationUpgrade]),
