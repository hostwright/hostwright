...
public enum HostwrightCapabilityCatalog {
    ...
    private static let catalog: [HostwrightCapability] = [
        ...
        capability("state.sqlite-v7", "Durable single-host SQLite state schema v7", .experimental, 2, 120, "The migration ledger and state-maintenance lifecycle are durable and fail-closed; generalized file-pressure hardening, extended disk-fault qualification, and long-soak evidence remain Phase 02 issue #115.", [.unitContract, .migrationUpgrade, .resilienceChaos]),
