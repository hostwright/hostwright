...
public enum HostwrightCapabilityCatalog {
    ...
    private static let catalog: [HostwrightCapability] = [
        ...
        capability("daemon.reconciliation", "Autonomous level-triggered reconciliation", .unavailable, 8, 194, "Level-triggered unattended reconciliation and durable restart budgets are implemented, but maintenance policy, rollout and rollback expansion, finalizers, retention, and complete checkpoint recovery remain unqualified.", [.localIntegration, .liveRuntime, .resilienceChaos]),
