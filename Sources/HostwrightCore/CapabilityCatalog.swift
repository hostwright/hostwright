...
public enum HostwrightCapabilityCatalog {
    ...
    private static let catalog: [HostwrightCapability] = [
        ...
        capability("foundation.secure-local-paths", "Secure macOS local paths and defaults", .stable, 2, 113, "State uses Application Support by default with explicit override precedence, private permissions, fail-closed path validation, and journaled legacy migration; backup contents and deeper SQLite repair remain their named Phase 02 workstreams.", [.unitContract, .localIntegration, .liveRuntime, .migrationUpgrade, .securityAssessment, .resilienceChaos]),
