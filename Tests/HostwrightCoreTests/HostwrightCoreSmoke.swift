...
final class HostwrightCoreTests: XCTestCase {
    ...
    func testReleaseDocsDescribeV002TruthAndPreserveHistory() throws {
        ...
        XCTAssertTrue(releaseProcess.contains("one complete clean RC qualification"))
        ...
        XCTAssertTrue(install.contains("That command is available through"))
        XCTAssertTrue(install.contains("v0.0.2-dev.11 -> 7d97d6c9ff878ec567c88e6993d4543ab8f0ad95"))
        XCTAssertTrue(install.contains("v0.0.2-dev.12 -> 71414005104933d8ee3591e8c91bc831bce2e2a2"))
        ...
        XCTAssertTrue(v002Plan.contains("## Reduced Phase Requirements"))
    ...
    func testStackImportDocsDescribeConversionOnlyBoundary() throws {
        ...
        XCTAssertTrue(guide.contains("Status: v0.0.2 local Compose conversion."))
        XCTAssertTrue(guide.contains("Missing or unrepresentable values fail closed with structured diagnostics and no manifest text"))
        ...
        XCTAssertTrue(limitations.contains("incomplete or unrepresentable resources return diagnostics and no manifest text"))
    ...
    func testControlPlaneDirectionKeepsCurrentCoreSingleHost() throws {
        ...
        XCTAssertTrue(readme.contains("Hostwright runs on one Mac. It has no multi-host control plane"))
    ...
    func testDocumentationSiteDocsDescribeSourceOfTruthBoundary() throws {
        ...
        XCTAssertTrue(readme.contains("[CLI reference](docs/reference/cli.md)"))
        XCTAssertTrue(readme.contains("[Limitations](docs/reference/limitations.md)"))
    ...
    func testBetaReadinessDocsKeepBetaBlockedUntilEvidence() throws {
        ...
        XCTAssertTrue(readme.contains("Status: `0.0.2-dev`, targeting `v0.0.2`. Hostwright is not production-ready."))
