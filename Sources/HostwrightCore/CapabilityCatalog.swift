...
public enum HostwrightCapabilityCatalog {
    ...
    private static let catalog: [HostwrightCapability] = [
        ...
        capability("architecture.contracts", "Versioned v0.0.2 public contracts", .experimental, 1, 110, "Manifest v2, Control API v2, Runtime Provider API v2, Storage Provider API v1, Network Provider SPI v1, plugin ABI v1, and state schema v17 are under active qualification.", [.unitContract, .migrationUpgrade]),
        ...
        capability("observability.telemetry", "Events, metrics, traces, logs, and support bundles", .experimental, 8, 194, "The durable local event ledger, redacted diagnostics, retention, and structured redacted OSLog are implemented; cursor/watch recovery, metrics, traces, support bundles, and leak-qualified soak evidence remain incomplete.", [.localIntegration, .resilienceChaos, .securityAssessment]),
