...
| Observability | Events, bounded logs, local diagnostics, OSLog, durable watches, bounded metrics/SLOs, correlated local traces, and retention. | Privacy-safe support bundles and aggregate leak/soak qualification are incomplete. | Yes. | P08. | No silent telemetry or automatic upload. |
