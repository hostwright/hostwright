...
- `hostwrightd --foreground` and the exact managed service mode level-trigger supported drift through the shared fenced lifecycle saga; later Phase 08 policy and observability gates remain incomplete.
