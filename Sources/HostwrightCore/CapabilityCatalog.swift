...
public enum HostwrightCapabilityCatalog {
    ...
    private static let catalog: [HostwrightCapability] = [
        ...
        capability("architecture.contracts", "Versioned v0.0.2 public contracts", .experimental, 1, 110, "Manifest v2, Control API v2, Runtime Provider API v2, Storage Provider API v1, plugin ABI v1, and state schema v15 are under active qualification.", [.unitContract, .migrationUpgrade]),
        ...
        capability("lifecycle.single-host", "Complete declarative single-host lifecycle", .stable, 4, 140, "Manifest v2 workloads execute through a durable schema-v15 operation DAG with dependency reconciliation, lifecycle and bounded interactive commands, typed probes, rolling or recreate updates, verified rollback, resumable recovery, and exact ownership-scoped cleanup.", [.unitContract, .localIntegration, .liveRuntime, .migrationUpgrade, .securityAssessment, .resilienceChaos]),
