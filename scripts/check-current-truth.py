...
def main() -> int:
    ...
    for fragment in ["manifest = 2", "controlAPI = 2", "runtimeProviderAPI = 2", "storageProviderAPI = 1", "pluginABI = 1", "stateSchema = 15"]:
    ...
    require("Manifest v2" in readme and "SQLite schema v15" in readme, "README lacks current manifest/state contracts", errors)
    ...
    require("Schema version 15 is the latest" in state, "state docs do not name schema v15", errors)
    require(
