...
- `healthy`: SQLite structure, foreign keys, schema v22 ledger/checksums, required tables, indexes, and security triggers, resource/fencing UUIDs, authoritative enums/JSON contracts, and reconstructible projections all pass;
