...
The [accepted scope](../design/adr-0015-reduced-local-release.md) is single-Mac CLI, local capacity admission, narrow Compose import, and confirmed native desktop lifecycle. Development evidence below does not replace final-version qualification.
