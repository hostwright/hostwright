...
public enum HostwrightCapabilityCatalog {
    ...
    private static let catalog: [HostwrightCapability] = [
        ...
        capability("networking.ingress", "Owned local HTTP and WebSocket ingress", .experimental, 7, 172, "The signed on-demand network helper provides UUID-owned localhost HTTP/1.1 and WebSocket routing with ready-only backends, bounded parsing and access evidence, atomic configuration generations, graceful drain, restart recovery, and exact cleanup; TLS, mTLS, LAN/public exposure, policy, and aggregate live qualification remain pending Phase 07 gates.", [.unitContract, .localIntegration, .liveRuntime, .securityAssessment, .resilienceChaos]),
