...
| `distribution-artifact` | Actual build, checksum, SBOM/provenance, signing, notarization, install, strict upgrade, downgrade refusal, verified rollback, repair, and uninstall stages that ran. | Any stage recorded as blocked or failed. |
