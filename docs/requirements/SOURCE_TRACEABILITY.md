...
| Reconciliation must load desired state, observe runtime, diff, plan, validate safety gates, persist intent, apply, record events, and observe again. | Document 1 | HW-RECON-001, HW-RECON-002, HW-RECON-003, HW-RECON-004, HW-RECON-005 | Partially implemented | Phase 7 implements deterministic non-mutating drift planning. Phase 8B adds a single confirmed createMissingService apply path with intent and result records. Observe-after-apply and general lifecycle management remain future. |
