...
public enum HostwrightCapabilityCatalog {
    ...
    private static let catalog: [HostwrightCapability] = [
        ...
        capability("api.control-v2", "Persistent local Control API v2", .experimental, 9, 206, "The authenticated bounded unary Unix-socket API enforces tamper-evident authorization and RBAC; streams, watches, recovery, and complete CLI parity remain incomplete.", [.unitContract, .localIntegration, .securityAssessment]),
