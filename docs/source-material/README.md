# Source Material Archive Note

This directory records the original project source material used to create the Hostwright repository foundation. The bulky internal documents, archive files, and generated brand-source images are not kept in the current public tree.

Maintainers should use the private archive for provenance review. The table below keeps the former public paths, sizes, and SHA-256 hashes so archived copies can be verified without reintroducing binary source material into the release tree.

## Archive Rules

- Keep original filenames in the private archive where possible.
...
- Do not restore bulky internal documents or generated image originals to the public tree without a maintainer decision.

## Archived Documents

| Old path | Former public path | Size | SHA-256 |
| --- | --- | ---: | --- |
