...
public enum DesktopActionCatalog {
    ...
    public static let cliActions: [DesktopCLIActionDescriptor] = [
        ...
        cli("state.restore", .bootstrapAPI),
        cli("state.repair", .bootstrapAPI),
        cli("state.recover", .bootstrapAPI),
        cli("state.compact", .bootstrapAPI),
        ...
        cli("daemon.bootstrap-identities", .bootstrapAPI),
        cli("daemon.status", .bootstrapAPI, guiElements: [
        ...
        cli("daemon.validate", .bootstrapAPI),
        cli("daemon.bootstrap", .bootstrapAPI),
        cli("daemon.start", .bootstrapAPI),
        cli("daemon.stop", .bootstrapAPI),
        cli("daemon.kickstart", .bootstrapAPI),
        cli("daemon.upgrade", .bootstrapAPI),
        cli("daemon.rollback", .bootstrapAPI),
        cli("daemon.disable", .bootstrapAPI),
