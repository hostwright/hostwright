...
The first supported release is intentionally narrow: one local Apple silicon Mac, macOS 26+, Apple container workloads, and a conservative control-plane foundation.
...
Hostwright should not present itself as a cluster orchestrator, compatibility shim, cloud control plane, web dashboard, or production hosting platform.
