...
public enum HostwrightCapabilityCatalog {
    ...
    private static let catalog: [HostwrightCapability] = [
        ...
        capability("lifecycle.single-host", "Complete declarative single-host lifecycle", .stable, 4, 140, "Manifest v2 workloads execute through a durable schema-v7 operation DAG with dependency reconciliation, lifecycle and bounded interactive commands, typed probes, rolling or recreate updates, verified rollback, resumable recovery, and exact ownership-scoped cleanup.", [.unitContract, .localIntegration, .liveRuntime, .migrationUpgrade, .securityAssessment, .resilienceChaos]),
