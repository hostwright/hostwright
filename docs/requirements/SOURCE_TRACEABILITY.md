...
| Reconciliation must load desired state, observe runtime, diff, plan, validate safety gates, persist intent, apply, record events, and observe again. | Document 1 | HW-RECON-001, HW-RECON-002, HW-RECON-003, HW-RECON-004, HW-RECON-005, HW-DAEMON-002, HW-DAEMON-004 | Partially implemented | Planning, create, managed start, status observation, cleanup events, and foreground daemon observe/plan/record behavior exist. Observe-after-apply, unattended daemon mutation, and general lifecycle management remain future. |
